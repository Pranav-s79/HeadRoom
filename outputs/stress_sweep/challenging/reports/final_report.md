...
Generated: 2026-06-19T05:16:43+00:00
...
|:------------|:----------------|:---------------------|----------:|
| calibration | linear_point    | mae                  |  1.5565   |
| calibration | linear_point    | rmse                 |  1.84756  |
| calibration | linear_point    | max_abs_error        |  4.5801   |
| calibration | forest_point    | mae                  |  2.12836  |
| calibration | forest_point    | rmse                 |  2.5266   |
| calibration | forest_point    | max_abs_error        |  5.60158  |
| calibration | quantile_upper  | empirical_coverage   |  0.964286 |
| calibration | quantile_upper  | average_bound        | 46.0298   |
| calibration | quantile_upper  | average_conservatism |  4.95476  |
| calibration | conformal_upper | empirical_coverage   |  0.964286 |
| calibration | conformal_upper | average_bound        | 46.0298   |
| calibration | conformal_upper | average_conservatism |  4.95476  |
| test_id     | linear_point    | mae                  |  1.88982  |
| test_id     | linear_point    | rmse                 |  2.43798  |
| test_id     | linear_point    | max_abs_error        |  5.8663   |
| test_id     | forest_point    | mae                  |  2.50859  |
| test_id     | forest_point    | rmse                 |  3.07145  |
| test_id     | forest_point    | max_abs_error        |  6.79946  |
| test_id     | quantile_upper  | empirical_coverage   |  0.779167 |
| test_id     | quantile_upper  | average_bound        | 45.6194   |
...
| calibration_empirical_coverage_before_conformal | calibration |    0.964286 |
| calibration_empirical_coverage_after_conformal  | calibration |    0.964286 |
| id_empirical_coverage_before_conformal          | test_id     |    0.779167 |
| id_empirical_coverage_after_conformal           | test_id     |    0.779167 |
| ood_empirical_coverage_before_conformal         | test_ood    |    0.548678 |
| ood_empirical_coverage_after_conformal          | test_ood    |    0.548678 |
...
|:------------------------------|:------------------------------------|-------------------:|--------------------------:|---------------------:|------------------:|-----------------:|--------------------:|-------------------------:|-------------------:|---------------:|
| random                        | deployable_baseline_sensor_observed |            64.0341 |                   42.9016 |                    0 |                30 |               75 |                 nan |                      nan |           0.547659 |       0.76     |
| round_robin                   | deployable_baseline_sensor_observed |            49.7306 |                   39.4123 |                    0 |                30 |               75 |                 nan |                      nan |           0.293975 |       0.709437 |
| coolest_core_observed         | deployable_baseline_sensor_observed |            63.6317 |                   43.7394 |                    0 |                30 |               75 |                 nan |                      nan |           1.22733  |       0.948052 |
| coolest_core_oracle_true_temp | oracle_privileged_true_temperature  |            51.2541 |                   40.0796 |                    0 |                30 |               75 |                 nan |                      nan |           0.273275 |       0.584416 |
| trend_aware_observed          | deployable_baseline_sensor_observed |            62.2808 |                   44.0204 |                    0 |                30 |               75 |                 nan |                      nan |           1.15257  |       0.948052 |
| point_prediction_rf           | model_based_sensor_observed         |            49.1699 |                   39.2426 |                    0 |                30 |               75 |                 nan |                      nan |           0.372139 |       0.840346 |
| uncalibrated_quantile         | model_based_sensor_observed         |            52.1133 |                   43.1991 |                    0 |                30 |               75 |                 nan |                      nan |           0.645584 |       0.922078 |
| conformal_upper_bound         | model_based_sensor_observed         |            46.2739 |                   38.9565 |                    0 |                30 |               75 |                   1 |                        1 |           0.330971 |       0.786667 |

## OOD Scheduler Metrics

| scheduler                     | baseline_type                       |   peak_temperature |   average_max_temperature |   hotspot_violations |   completed_tasks |   assigned_tasks |   marginal_coverage |   selected_core_coverage |   drift_mean_abs_z |   drift_max_ks |
|:------------------------------|:------------------------------------|-------------------:|--------------------------:|---------------------:|------------------:|-----------------:|--------------------:|-------------------------:|-------------------:|---------------:|
| random                        | deployable_baseline_sensor_observed |            75.065  |                   50.7513 |                    0 |                40 |              104 |          nan        |               nan        |           1.08321  |       0.961538 |
| round_robin                   | deployable_baseline_sensor_observed |            68.7522 |                   47.3824 |                    0 |                40 |              104 |          nan        |               nan        |           1.06964  |       0.942308 |
| coolest_core_observed         | deployable_baseline_sensor_observed |            93.3454 |                   58.1571 |                    8 |                40 |              104 |          nan        |               nan        |           2.36056  |       0.951923 |
| coolest_core_oracle_true_temp | oracle_privileged_true_temperature  |            61.4923 |                   48.2045 |                    0 |                40 |              104 |          nan        |               nan        |           1.02557  |       0.817308 |
| trend_aware_observed          | deployable_baseline_sensor_observed |            91.6303 |                   58.5911 |                   10 |                40 |              104 |          nan        |               nan        |           2.24815  |       0.951923 |
| point_prediction_rf           | model_based_sensor_observed         |            55.0556 |                   43.1946 |                    0 |                40 |              104 |          nan        |               nan        |           0.907339 |       0.951923 |
| uncalibrated_quantile         | model_based_sensor_observed         |            59.6971 |                   47.4479 |                    0 |                40 |              104 |          nan        |               nan        |           0.992076 |       0.778846 |
| conformal_upper_bound         | model_based_sensor_observed         |            56.7686 |                   43.6335 |                    0 |                40 |              104 |            0.766226 |                 0.759615 |           0.94159  |       0.951923 |
...
| ood     | conformal_upper_bound | marginal_all_candidates_on_visited_states |                0.9 |             0.766226 | 1664 |
...
|:---------------|:------------------------------|-------------------:|--------------------------:|---------------------:|------------------:|-------------------------:|
| challenging_id | random                        |            64.0341 |                   42.9016 |                    0 |                30 |                      nan |
| challenging_id | round_robin                   |            49.7306 |                   39.4123 |                    0 |                30 |                      nan |
| challenging_id | coolest_core_observed         |            63.6317 |                   43.7394 |                    0 |                30 |                      nan |
| challenging_id | coolest_core_oracle_true_temp |            51.2541 |                   40.0796 |                    0 |                30 |                      nan |
| challenging_id | trend_aware_observed          |            62.2808 |                   44.0204 |                    0 |                30 |                      nan |
| challenging_id | point_prediction_rf           |            49.1699 |                   39.2426 |                    0 |                30 |                      nan |
| challenging_id | uncalibrated_quantile         |            52.1133 |                   43.1991 |                    0 |                30 |                      nan |
| challenging_id | conformal_upper_bound         |            46.2739 |                   38.9565 |                    0 |                30 |                        1 |
...
|:--------|:------------------------------|-------------------:|---------------:|
| id      | coolest_core_observed         |           1.22733  |       0.948052 |
| id      | trend_aware_observed          |           1.15257  |       0.948052 |
| id      | uncalibrated_quantile         |           0.645584 |       0.922078 |
| id      | random                        |           0.547659 |       0.76     |
| id      | point_prediction_rf           |           0.372139 |       0.840346 |
| id      | conformal_upper_bound         |           0.330971 |       0.786667 |
| id      | round_robin                   |           0.293975 |       0.709437 |
| id      | coolest_core_oracle_true_temp |           0.273275 |       0.584416 |
| ood     | coolest_core_observed         |           2.36056  |       0.951923 |
| ood     | trend_aware_observed          |           2.24815  |       0.951923 |
| ood     | random                        |           1.08321  |       0.961538 |
| ood     | round_robin                   |           1.06964  |       0.942308 |
| ood     | coolest_core_oracle_true_temp |           1.02557  |       0.817308 |
| ood     | uncalibrated_quantile         |           0.992076 |       0.778846 |
| ood     | conformal_upper_bound         |           0.94159  |       0.951923 |
| ood     | point_prediction_rf           |           0.907339 |       0.951923 |

Largest feature-level shifts:

| split   | scheduler             | feature                |   calibration_mean |   visited_mean |   abs_mean_z_shift |   ks_stat |
|:--------|:----------------------|:-----------------------|-------------------:|---------------:|-------------------:|----------:|
| id      | random                | power_4                |           0.363851 |        6.40563 |           17.5412  |  0.76     |
| id      | uncalibrated_quantile | load_2                 |          10.961    |       79.5867  |            7.29034 |  0.853333 |
| id      | random                | load_4                 |           7.98701  |       71.5333  |            7.19821 |  0.694372 |
| id      | coolest_core_observed | load_3                 |          18.2338   |      139.307   |            6.14574 |  0.733333 |
| id      | uncalibrated_quantile | power_2                |           0.93327  |        4.97031 |            5.57854 |  0.85368  |
| id      | point_prediction_rf   | power_4                |           0.363851 |        2.209   |            5.35706 |  0.746667 |
| id      | coolest_core_observed | power_12               |           1.74756  |        5.79843 |            4.96272 |  0.802771 |
| id      | trend_aware_observed  | power_12               |           1.74756  |        5.46157 |            4.55003 |  0.616104 |
| id      | coolest_core_observed | power_3                |           1.25471  |        7.14685 |            4.53376 |  0.706667 |
| id      | trend_aware_observed  | power_3                |           1.25471  |        6.29999 |            3.88214 |  0.733333 |
| id      | coolest_core_observed | sensor_temp_imputed_3  |          36.5603   |       43.645   |            3.75999 |  0.630823 |
| id      | trend_aware_observed  | load_3                 |          18.2338   |       88.0267  |            3.54274 |  0.72     |
| id      | round_robin           | load_1                 |          12.8442   |       47.92    |            3.30629 |  0.680346 |
| id      | round_robin           | power_1                |           0.831929 |        2.91517 |            3.20494 |  0.590476 |
| id      | trend_aware_observed  | load_12                |          27.5974   |       82.8     |            3.13526 |  0.563117 |
| id      | trend_aware_observed  | sensor_temp_imputed_3  |          36.5603   |       42.2348  |            3.01155 |  0.510823 |
| id      | conformal_upper_bound | power_4                |           0.363851 |        1.35992 |            2.89191 |  0.786667 |
| id      | coolest_core_observed | sensor_temp_imputed_12 |          37.4813   |       43.0368  |            2.83808 |  0.468052 |
| id      | point_prediction_rf   | load_2                 |          10.961    |       37.1067  |            2.77754 |  0.734372 |
| id      | trend_aware_observed  | power_15               |           2.45128  |        6.88868 |            2.77582 |  0.653333 |
